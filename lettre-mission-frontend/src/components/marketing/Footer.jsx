        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">
              Simplifiez la gestion de vos lettres de mission avec une solution moderne et efficace conçue pour les experts-comptables.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/gdpr" className="text-base text-gray-500 hover:text-gray-900">
                      RGPD
                    </Link>
                  </li>
                </ul>
