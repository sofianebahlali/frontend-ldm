  ...
  return (
    <div className={`bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden ${className}`}>
      <div className="px-5 py-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <Link to="/clients/add" className="text-sm font-medium text-black hover:text-gray-700 flex items-center">
                ...
                {clients.map((client) => (
                  <tr key={client.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <Link to={`/clients/edit/${client.id}`} className="text-black hover:text-gray-700">
                        Voir
                      </Link>
                    </td>
                  </tr>
      ...
      {clients.length > 0 && (
        <div className="bg-gray-50 px-5 py-3">
          <div className="text-sm">
            <Link to="/clients" className="font-medium text-black hover:text-gray-700">
