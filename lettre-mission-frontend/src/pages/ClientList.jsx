...
const ClientList = () => {
  ...
  const handleDeleteClient = async () => {
    ...
    try {
      ...
      setSuccess({
        message: `Le client "${clientToDelete.denom_social}" a été supprimé avec succès`,
        type: 'success'
      });
  ...
  return (
    <div className="py-6">
      <header className="flex justify-between items-center mb-8">
        ...
        <Link
          to="/clients/add"
          className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black dark:bg-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black dark:focus:ring-white"
        >
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div className="w-full md:w-1/2 mb-4 md:mb-0">
            ...
            <div className="relative">
              ...
              <input
                ...
                name="search"
                type="text"
                className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md leading-5 bg-white dark:bg-gray-700 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white sm:text-sm"
          ...
          <div className="w-full md:w-auto">
            ...
            <select
              id="filter"
              name="filter"
              className="block w-full py-2 pl-3 pr-10 text-base border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white sm:text-sm rounded-md"
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm overflow-hidden sm:rounded-lg border border-gray-200 dark:border-gray-700">
        {loading ? (
          <div className="py-12 text-center">
            <div className="animate-spin inline-block w-8 h-8 border-4 border-gray-200 dark:border-gray-600 border-t-black dark:border-t-white rounded-full"></div>
          ...
          <div className="py-12 text-center">
            ...
            {!searchQuery && selectedFilter === 'all' && (
              <div className="mt-6">
                <Link
                  to="/clients/add"
                  className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-black dark:bg-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 focus:outline-none"
                >
                  ...
                  <tr key={client.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10 rounded-full bg-gray-100 dark:bg-gray-600 flex items-center justify-center text-gray-500 dark:text-gray-300">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 dark:text-white">{client.Nom_representantclient || 'Non spécifié'}</div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex justify-end space-x-3">
                        <Link to={`/clients/edit/${client.id}`} className="text-black dark:text-white hover:text-gray-800 dark:hover:text-gray-200">
